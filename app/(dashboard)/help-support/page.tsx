        ...
        {ticketsQuery.isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="table-grid min-w-full">
              ...
              <tbody>
                {tickets.map((ticket) => (
                  <tr key={ticket._id} className="border-b border-[var(--border)] last:border-b-0">
                    ...
                    <td className="px-6 py-6 text-lg font-medium text-[var(--foreground)]">
                      {ticket.subject}
                    </td>
                    <td className="px-6 py-6 text-lg text-[var(--muted-foreground)]">
                      <p className="max-w-[380px] leading-7">{ticket.description}</p>
                    </td>
                  </tr>
                ))}
              </tbody>
