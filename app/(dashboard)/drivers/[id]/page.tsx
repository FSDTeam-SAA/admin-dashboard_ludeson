...
function DocumentPreview({ label, image }: { label: string; image?: string }) {
  return (
        ...
        <CardContent className="space-y-5">
          <div className="grid gap-5 md:grid-cols-3">
            <InfoField
              ...
              value={driver.vehicle_brand_name}
            />
            <InfoField
              label="Vehicle Model Name"
              value={driver.vehicle_model_name}
            />
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            <DocumentPreview
              label="Vehicle Image"
              image={driver.documents.vehicle_image_url}
            />
            <DocumentPreview
              label="Passport"
              image={driver.documents.passport_image_url}
            />
            <DocumentPreview
